...
read_these_sheets <- c('dd.WW4_629_N1-N2', 'dd.WW5_630_N1-N2') # sheet name(s) in the raw data file (qPCR data dump) - Separate by comma (,)
title_name <- '629 part1' # name of the filename for writing presentable data and plot title
...
biobot_lookup <- map_df(bb_sheets , ~ read_sheet('https://docs.google.com/spreadsheets/d/1ghb_GjTS4yMFbzb65NskAlm-2Gb5M4SNYi4FHE4YVyI/edit#gid=233791008', sheet = .x)) %>% 
