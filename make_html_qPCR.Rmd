...
read_these_sheets <- c('WW20_622_N1-N2', 'WW22_622_BCoV') # sheet name(s) in the raw data file (qPCR data dump) - Separate by comma (,)
...
long_targets_vol %>% ggplot(aes(x = N1_multiplex, y = N2_multiplex)) + geom_point() + geom_abline(slope = 1, intercept = 0) + geom_label(aes(x = 4, y = 4, label = 'y = x'))
...
long_targets_vol_summary %>% ggplot(aes(x = N1_multiplex, y = N2_multiplex)) + geom_point() + geom_abline(slope = 1, intercept = 0, aes(colour = 1)) + geom_label(aes(x = 4, y = 4, label = 'y = x'))
...
```{r n2bcov}
long_targets_vol_summary %>% ggplot(aes(x = BCoV_M, y = N2_multiplex)) + geom_point() + geom_abline(slope = 1, intercept = 0, aes(colour = 1)) + geom_label(aes(x = 4, y = 4, label = 'y = x'))
