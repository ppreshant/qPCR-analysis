...
presentable_vol_qpcr <- vol_qpcr %>% rename('Facility' = `FACILITY NAME`) %>% 
  ...
  mutate_cond(str_detect(Target, 'N'), `Recovery fraction` = NA) %>% 
...
write_sheet(presentable_vol_qpcr,'https://docs.google.com/spreadsheets/d/1ltvW7xZf2aUPoBchD4NFGuV0gGWPkdsOW3a0Hxalm-Y/edit#gid=1992098439', sheet = title_name) # save results to a google sheet
...
write_sheet(present_N_data,'https://docs.google.com/spreadsheets/d/1dBESjgWSFsOBodFFpYNhWIOAQ2a3wvoLkrn12V_rFck/edit#gid=2072146759', sheet = title_name) # save results to a google sheet
