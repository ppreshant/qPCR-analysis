...
title_name <- 'test pMMoV' # name of the filename for writing presentable data and plot title
...
presentable_vol_qpcr <- vol_qpcr %>% 
  ...
  mutate(WWTP_ID = if_else(biological_replicates == ''|is.na(biological_replicates), WWTP , str_c(WWTP, '-', biological_replicates))) %>% 
