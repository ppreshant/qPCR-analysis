...
flnm <- 'Std8_Bovine_28-5-20'  # set the filename
...
plt <- plotstdcurve(fl,'qPCR Standard curve 8: Bovine standards', 'log(Copy #)') # plot standard curve
...
plt + geom_label_repel(data = std_table$dat, label = std_table$equation, parse = TRUE, show.legend = F, nudge_x = -5)
ggsave('qPCR analysis/Std8_Bovine.png', width = 5, height = 4)
